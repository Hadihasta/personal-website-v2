...
const DisplaySlide = () => {
  ...
  useEffect(() => {
    ...
    // wrap kalau lebih kecil dari 0 maka balik ke section lengt tapi kalau lebih besar dari section length balik ke 0
    ...
    gsap.set('.slide:nth-of-type(0) .slide__outer', { xPercent: 0 })
    gsap.set('.slide:nth-of-type(0) .slide__inner', { xPercent: 0 })
  ...
  return (
    ...
    {/* overflow-hidden flex-col */}
      <div
        className="flex  bg-blueDisable p-10 "
        ref={containerRef}
      > scroll here
        <div className="slide bg-amber-50 ">
          <div className="slide__outer bg-blue-300 ">
            <div className="slide__inner  bg-red-700 ">
              <Image
                width={200}
                height={200}
                alt="Hadi"
        ...
        {/* <div className="slide bg-amber-800 ">
        ...
        <div className="slide bg-red-700 ">
          <div className="slide__outer">
            <div className="slide__inner">
              <Image
                width={200}
